...
product.set("username", "jambiebs");
let array1 = [1,2,3,4];
let array2 = ["one", "two", "three", "four"];
product.set(array1, array2);
let obj1 = {
    uname: "jambiebs"
}
let obj2 = {
...
product.set(nested1,nested2);
// console.log(product.get(obj1).uname); // output is undefined why 
...
// //<====access the key of the given map====>

// // for(let key of product.keys()){
// //     console.log(key);
// // }

// //<====access the key-value-pair of the given map====>

// // for(let key of product){
// //     console.log(key);
// // }

// //<====access the key-value of the given map====>
...
// // console.log(product.length); // output: undefined
// // console.log(product[0]); // output: undefined
// // console.log(product.nested1);

// unsolved problem 
// access the property of obj 1
console.log(product.get(obj1).uname); //output is undefined
console.log(product.get(obj1));

// conclusion
// as per my current knowledge we shouldn't use object as a key in maps because till now I haven't found any method to retrieve it's properties;
